...
export const FINANCE_LICENSES: FinanceLicense[] = ['SIE','Series 6','Series 7','Series 63','Series 65','Series 66','Series 79','Series 3','CPA','CPA Track','CFA Level 1','None Required']description: string | null
  created_at: string
}
