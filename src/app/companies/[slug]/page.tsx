          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <div className="flex flex-wrap items-center gap-3 mt-3">
                {company.careers_url && (
                  <a href={company.careers_url} target="_blank" rel="noopener noreferrer nofollow" aria-label={`${company.name} careers page (opens in new tab)`} className="inline-flex items-center gap-1.5 text-xs font-medium text-emerald-400 hover:text-emerald-300 transition">
                ...
                {company.website && (
                  <a href={company.website} target="_blank" rel="noopener noreferrer nofollow" aria-label={`${company.name} website (opens in new tab)`} className="inline-flex items-center gap-1.5 text-xs font-medium text-navy-400 hover:text-navy-200 transition">
