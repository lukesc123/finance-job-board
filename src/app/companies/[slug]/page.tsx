            ...
            <div>
              ...
              <div className="flex flex-wrap items-center gap-3 mt-3">
                {safeUrl(company.careers_url) && (
                  <a href={safeUrl(company.careers_url)!} target="_blank" rel="noopener noreferrer nofollow" aria-label={`${company.name} careers page (opens in new tab)`} className="inline-flex items-center gap-1.5 text-xs font-medium text-emerald-400 hover:text-emerald-300 transition">
                ...
                {safeUrl(company.website) && (
                  <a href={safeUrl(company.website)!} target="_blank" rel="noopener noreferrer nofollow" aria-label={`${company.name} website (opens in new tab)`} className="inline-flex items-center gap-1.5 text-xs font-medium text-navy-400 hover:text-navy-200 transition">
                    <svg className="h-3.5 w-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9" /></svg>
                    Website
                  </a>
                )}
              </div>
