  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <h2 className="text-lg font-bold text-navy-900 mb-2">Failed to load categories</h2>
        <p className="text-sm text-navy-500 mb-6">Something went wrong while loading job categories. Please try again.</p>
